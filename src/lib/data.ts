// Build-time data loader. Reads the same build/full-data/staticData.json the Next app
...
// breaks. cwd is stable across dev + bundled build -> build/full-data/staticData.json.
