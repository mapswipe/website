...
// glob() loader points DIRECTLY at the repo-root `blogs/` dir — NO files are
// moved. Astro renders each entry's markdown body via entry.render() using the
// project's markdown pipeline (remark-gfm is enabled in astro.config.mjs,
// matching Next).
//
