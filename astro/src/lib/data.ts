...
// after Vite bundles this module into dist/, a relative specifier resolves from
// the emitted file's location (dist/pages/...) and breaks. cwd is stable across
// dev + bundled build. astro/ -> ../fullData/staticData.json.
